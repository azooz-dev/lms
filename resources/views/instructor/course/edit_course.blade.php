...
<div class="page-content">
    ...
    <div class="card">
        <div class="card-body p-4">
            <form action="{{ route('instructor.update_course', $course->id) }}" method="POST" id="myForm" class="row g-3" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="col-md-6">
                    <label for="input1" class="form-label">Course Name</label>
                    <input type="text" class="form-control" value="{{ $course->name }}"  name="name" id="name" placeholder="Enter the course name">
                </div>

                
                <div class="col-md-6">
                    <label for="input1" class="form-label">Course Title</label>
                    <input type="text" class="form-control" value="{{ $course->title }}" name="title" id="title" placeholder="Enter the course title">
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <select name="level" class="form-select mb-3" aria-label="Default select example">
                        ...
                        <option value="Advance" {{ $course->course_level == 'Advance' ? 'selected' : '' }}>Advance</option>
                    </select>
                </div>

                <div class="col-md-6">
                    <label for="input1" class="form-label">Course Price</label>
                    <input type="text" class="form-control" value="{{ $course->selling_price }}" name="selling_price" id="selling_price">
                </div>

                <div class="col-md-6">
                    <label for="input1" class="form-label">Descount Price</label>
                    <input type="text" class="form-control" value="{{ $course->discount_price }}" name="discount_price" id="discount_price">
                </div>

                <div class="col-md-6">
                    <label for="input1" class="form-label">Duration</label>
                    <input type="text" class="form-control" value="{{ $course->duration }}" name="duration" id="duration">
                </div>

                <div class="col-md-6">
                    <label for="input1" class="form-label">Resources</label>
                    <input type="text" class="form-control" value="{{ $course->resources }}"  name="resources" id="resources">
                </div>

                <div class="col-md-12">
                    <label for="input1" class="form-label">Course Prerequisites</label>
                    <textarea class="form-control" id="input11" placeholder="Prerequisites ..." name="prerequisites" rows="3">{{ $course->prerequisites }}</textarea>
                </div>

                <div class="col-md-12">
                    <label for="input1" class="form-label">Course Description</label>
                    <textarea class="form-control" id="myeditorinstance" placeholder="Description ..." name="description">{!! $course->description !!}</textarea>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="file-upload-content">
                        ...
                        <input type="hidden" id="currentImageUrl"  value="{{ Storage::url('upload/course/images/' . $course->image) }}">
                    </div>
                </div>
                ...
                <div class="row ms-lg-auto">
                    <div class="col-md-4">
                        <div class="form-check">
                            <input class="form-check-input" style="border: 1px solid #00000063" type="checkbox" {{ $course->best_seller == 1 ? 'checked' : '' }} name="best_seller" value="1" id="best_seller">
                    ...
                    <div class="col-md-4">
                        <div class="form-check">
                            <input class="form-check-input" style="border: 1px solid #00000063" type="checkbox" {{ $course->featured == 1 ? 'checked' : '' }} name="featured" value="1" id="featured">
                    ...
                    <div class="col-md-4">
                        <div class="form-check">
                            <input class="form-check-input" style="border: 1px solid #00000063" type="checkbox" {{ $course->highest_rated == 1 ? 'checked' : '' }} name="highest_rated" value="1" id="highest_rated">
                ...
                <div class="col-md-2 ms-auto me-auto" style="margin-top: 12px;">
                    <div class="d-md-flex d-grid align-items-center gap-3" style="margin: 0">
                        <button type="submit" style="margin: 0; font-weight: bold;" class="btn btn-primary px-4 w-100">Save Changes</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('instructor.update_video', $course->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <label for="input1" class="form-label mt-3">Current Video</label>
                <div class="col-md-6">
                    <video width="320" height="130" controls class="rounded">
                        <source src="{{ Storage::url('upload/course/videos/' . $course->video_link) }}" type="video/mp4">
                    </video>
                </div>

                <div class="col-md-2" style="margin-top: 12px;">
                    <div class="d-md-flex d-grid align-items-center gap-3" style="margin: 0">
                        <button type="submit" style="margin: 0; font-weight: bold;" class="btn btn-primary px-4 w-100">Save Video</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('instructor.update_goals', $course->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                        ...
                        <div class="container mt-2">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6" style="padding-top: 30px;">
                                    <a class="btn btn-success btn-sm addeventmore"><i class="fa fa-plus-circle"></i> Add More..</a>
                        ...
                        <div class="container mt-2">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="goals" class="form-label"> Goals </label>
                                        <input type="text" name="course_goals[]" id="goals" value="{{ $goal->goal }}" class="form-control" placeholder="Goals ">
                                    </div>
                                </div>
                                <div class="form-group col-md-6" style="padding-top: 30px;">
                                    <a class="btn btn-success btn-sm addeventmore"><i class="fa fa-plus-circle"></i> Add More..</a>
...
<script>
        ...
        const subCategoriesSelect = document.getElementById('sub_category');
            ...
            .then(data => {
                data.forEach(element => {
                    if(element.id == {{ $course->sub_category_id }}){
    ...
    selectElement.addEventListener('change', (event) => {
        ...
        const subCategoriesSelect = document.getElementById('sub_category');
        console.log(subCategoriesSelect.options.length);
