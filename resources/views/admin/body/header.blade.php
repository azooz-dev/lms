        ...
        <nav class="navbar navbar-expand gap-3">
            ...
            <div class="user-box dropdown px-3">
                <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{ (!empty(Auth::user()->photo)) ? Storage::url('public/upload/admin_images/'. Auth::user()->photo) : asset('storage/upload/images.jpg') }}" class="user-img" alt="user avatar" width="200px">
                    <div class="user-info">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li><a class="dropdown-item d-flex align-items-center" href="{{ route('admin.change_password') }}"><i class='bx bx-lock-open' style="font-size: 19px;"></i><span>Change Password</span></a>
                    </li>
