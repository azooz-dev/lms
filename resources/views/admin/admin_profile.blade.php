                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.update', Auth::user()->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <img id="showImage" src="{{ (!empty(Auth::user()->photo)) ? Storage::url('public/upload/admin_images/'. Auth::user()->photo) : asset('storage/upload/images.jpg') }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="80" height="80">
                                    </div>
                                </div>
                                <div class="row">
