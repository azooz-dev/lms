                ...
                <div class="col-lg-6">
                    <div class="header-widget">
                        <ul class="generic-list-item d-flex flex-wrap align-items-center fs-14">
                            <li class="d-flex align-items-center pr-3 mr-3 border-right border-right-gray"><i class="la la-phone mr-1"></i><a href="tel:00123456789"> (+966) {{ $site->phone_site }}</a></li>
                            <li class="d-flex align-items-center"><i class="la la-envelope-o mr-1"></i><a href="mailto:contact@aduca.com"> {{ $site->email_site }}</a></li>
                        </ul>
                ...
                <div class="col-lg-6">
                    <div class="header-widget d-flex flex-wrap align-items-center justify-content-end">
                        ...
                        <ul class="generic-list-item d-flex flex-wrap align-items-center fs-14 border-left border-left-gray pl-3 ml-3">
                            <li class="d-flex align-items-center pr-3 mr-3 border-right border-right-gray"><i class="la la-tachometer mr-1"></i><a href="{{ route('dashboard') }}">Dashboard</a></li>
                            <li class="d-flex align-items-center"><i class="la la-sign-out mr-1"></i><a href="{{ route('user.logout') }}">Logout</a></li>
                        </ul>
                        @else
                        <ul class="generic-list-item d-flex flex-wrap align-items-center fs-14 border-left border-left-gray pl-3 ml-3">
        ...
        <div class="container-fluid">
            <div class="main-menu-content">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-2">
                        <div class="logo-box">
                            <a href="{{ route('index') }}" class="logo"><img src="{{ Storage::url('upload/logo/'. $site->logo) }}" alt="logo"></a>
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <ul class="cat-dropdown-menu">
                                            ...
                                            <li>
                                                <a href="{{ route('category_courses', ['id' => $category->id, 'slug' => $category->category_slug]) }}">{{ $category->category_name }} <i class="la la-angle-right"></i></a>
                                                <ul class="sub-menu">
                                                    @foreach ($category->subCategories as $subCategory)
                                                    <li><a href="{{ route('subCategory_courses', ['id' => $subCategory->id, 'slug' => $subCategory->subCategory_slug]) }}">{{ $subCategory->subCategory_name }}</a></li>
                                                    @endforeach
                                                </ul>
                                            </li>
                                            @endforeach
                                ...
                                <ul>
                                    <li>
                                        <p class="shop-cart-btn d-flex align-items-center">
                                            ...
                                            <span class="product-count" id="mini-cart-count">2</span>
                                        </p>
                                        <ul class="cart-dropdown-menu">
                                            <div class="mb-3" id="mini-cart">

                                            </div>

                                            <li class="media media-card">
                                                <div class="media-body fs-16">
                                                    <p class="text-black font-weight-semi-bold lh-18">Total: <span class="cart-total" id="cart-total">$12.99</span> <span class="before-price fs-14" id="before-price">$129.99</span></p>
                                                </div>
                                            </li>
                                            <li>
                                                <a href="{{ route('show_cart') }}" class="btn theme-btn w-100">Got to cart <i class="la la-arrow-right icon ml-1"></i></a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
