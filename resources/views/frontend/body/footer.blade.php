        ...
        <div class="row">
            <div class="col-lg-3 responsive-column-half">
                <div class="footer-item">
                    <a href="index.html">
                        <img src="{{ Storage::url('upload/logo/'. $site->logo) }}" alt="footer logo" class="footer__logo">
                    </a>
                    <ul class="generic-list-item pt-4">
                        <li><a href="tel:+1631237884">+966{{ $site->phone_site }}</a></li>
                        <li><a href="mailto:support@wbsite.com">{{ $site->email_site }}</a></li>
                        <li>{{ $site->address_site }}</li>
                    </ul>
                    <h3 class="fs-20 font-weight-semi-bold pt-4 pb-2">We are on</h3>
                    <ul class="social-icons social-icons-styled">
                        <li class="mr-1"><a href="{{ $site->facebook }}" class="facebook-bg"><i class="la la-facebook"></i></a></li>
                        <li class="mr-1"><a href="{{ $site->twitter }}" class="twitter-bg"><i class="la la-twitter"></i></a></li>
                        <li class="mr-1"><a href="{{ $site->instagram }}" class="instagram-bg"><i class="la la-instagram"></i></a></li>
                        <li class="mr-1"><a href="{{ $site->linkedin }}" class="linkedin-bg"><i class="la la-linkedin"></i></a></li>
                    </ul>
                </div><!-- end footer-item -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column-half">
                <div class="footer-item">
                    ...
                    <ul class="generic-list-item">
                        ...
                        <li><a href="{{ route('become_instructor') }}">Become a Teacher</a></li>
    ...
    <div class="copyright-content py-4">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <p class="copy-desc">{{ $site->copyright }} by <a href="#">AzoozDev</a></p>
                </div><!-- end col-lg-6 -->
                <div class="col-lg-6">
