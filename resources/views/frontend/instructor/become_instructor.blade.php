...
@section('title')
Register Instructor | Easy Learning
@endsection
        ...
        <div class="row pt-50px">
            <div class="col-lg-10 mx-auto">
                <div class="card card-item">
                    <div class="card-body">
                        <form action="{{ route('register_instructor') }}" method="POST" class="row">
                            @csrf
                            <div class="input-box col-lg-6">
                                <label class="label-text">Name</label>
                                <div class="form-group">
                                    <input class="form-control form--control @error('name') is-invalid @enderror" type="text" name="name" placeholder="e.g. Alex Smith">
                            ...
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control @error('username') is-invalid @enderror" type="text" name="username" placeholder="e.g. alexsmith">
                                    <span class="la la-user input-icon"></span>
                                    @error('username')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control @error('address') is-invalid @enderror" type="text" name="address" placeholder="e.g. 12345 Little Baker St, Melbourne">
                            ...
                            <div class="input-box col-lg-12">
                                ...
                                <div class="form-group">
                                    <input id="phone" class="form-control form--control @error('phone') is-invalid @enderror" type="text" name="phone" placeholder="e.g. 123-456-7890">
                            ...
                            <div class="input-box col-lg-12">
                                <label class="label-text">Desciption</label>
                                <div class="form-group">
                                    <textarea class="form-control" name="bio" id="myeditorinstance"></textarea>
                                </div>
                            </div><!-- end input-box -->
