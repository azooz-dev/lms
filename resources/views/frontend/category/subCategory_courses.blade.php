    ...
    <div class="container">
        <div class="filter-bar mb-4">
            <div class="filter-bar-inner d-flex flex-wrap align-items-center justify-content-between">
                <p class="fs-14">We found <span class="text-black">{{ $subCategory->courses->count() }}</span> courses available for you</p>
        ...
        <div class="row">
                    ...
                    <div class="card card-item">
                        <div class="card-body">
                            ...
                            <ul class="generic-list-item">
                                ...
                                <li><a href="{{ route('category_courses', ['id' => $cat->id, 'slug' => $cat->category_slug]) }}">{{ $cat->category_name }}</a></li>
                                @endforeach
                            </ul>
                        </div>
                    </div><!-- end card -->
            ...
            <div class="col-lg-8">
                <div class="row">
                    @foreach ($subCategory->courses->where('status', 1)->sortBy('created_at') as $course)
                    <div class="col-lg-6 responsive-column-half">
                        <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_1">
                            <div class="card-image">
                                <a href="{{ route('course_details', ['id' => $course->id, 'slug' => $course->slug]) }}" class="d-block">
                                    <img class="card-img-top lazy" src="{{ Storage::url('upload/course/images/'.$course->image) }}" data-src="{{ Storage::url('uploads/course/images/'.$course->image) }}" alt="Card image cap">
                                </a>
                            ...
                            <div class="card-body" style="padding: 1.6rem 2.6rem;">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="icon-element icon-element-sm shadow-sm cursor-pointer" title="Add to Wishlist"><i class="la @foreach ($wishLists as $wishList)
                                        @if ($wishList->user_id == Auth::user()->id && $wishList->course_id == $course->id) la la-heart icon-red @else la la-heart-o @endif
                                        @endforeach"></i></div>
                                    </div>
                                    @endif
                                </div>
