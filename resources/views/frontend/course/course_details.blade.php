        ...
        <div class="col-lg-8 mr-auto">
            <div class="breadcrumb-content">
                ...
                <div class="bread-btn-box pt-3">
                    @auth
                        <button class="btn theme-btn theme-btn-sm theme-btn-transparent lh-28 mr-2 mb-2 wish-btn" id="{{ $course->id }}" onclick="addToWishlist(this.id)">
        ...
        <div class="row">
            <div class="col-lg-8 pb-5">
                <div class="course-details-content-wrap pt-90px">
                                ...
                                <div class="card">
                                    <div class="card-header" id="heading{{ $section->id }}">
                                        <button class="btn btn-link d-flex align-items-center justify-content-between" data-toggle="collapse" data-target="#collapse{{ $section->id }}" aria-expanded="true" aria-controls="collapse{{ $section->id }}">
                                            ...
                                            <span class="fs-15 text-gray font-weight-medium">{{ $section->lectures->count() }} lectures</span>
                                        </button>
                                    </div><!-- end card-header -->
                                    <div id="collapse{{ $section->id }}" class="collapse @if ($key == 0) show @endif" aria-labelledby="heading{{ $section->id }}" data-parent="#accordion">
                                        <div class="card-body">
                            ...
                            <div class="media media-card">
                                <div class="instructor-img">
                                    <a href="teacher-detail.html" class="media-img d-block">
                                        <img class="lazy" src="{{ (!empty($course->instructor->photo)) ? Storage::url('public/upload_images/instructor_images/'. $course->instructor->photo) : asset('storage/upload/images.jpg') }}"  alt="Avatar image">
                                    </a>
                                    <ul class="generic-list-item pt-3">
                                        ...
                                        <li><i class="la la-play-circle-o mr-2 text-color-3"></i> {{ $course->instructor->courses->count() }} Courses</li>
                                        <li><a href="teacher-detail.html">View all Courses</a></li>
                                    </ul>
                                </div><!-- end instructor-img -->
                                <div class="media-body">
                                    <h5><a href="{{ route('instructor_details', $course->instructor->id) }}">{{ $course->instructor->name }}</a></h5>
                                    <span class="d-block lh-18 pt-2 pb-3">Joined {{ $course->instructor->created_at->diffForHumans() }}</span>
                        ...
                        <div class="feedback-wrap">
                            <div class="media media-card align-items-center">
                                <div class="review-rating-summary">
                                    <span class="stats-average__count">{{ round($course->averageReviewScore->average_score, 1) }}</span>
                                        ...
                                        <div class="review-bars__fill">
                                            <div class="skillbar-box">
                                                <div class="skillbar" data-percent="{{ round($rate['percentage']) }}%">
                                                    <div class="skillbar-bar bg-3" style="width: {{ round($rate['percentage']) }}%;"></div>
                                                </div> <!-- End Skill Bar -->
                                            </div>
                                        </div><!-- end review-bars__fill -->
                                        <div class="review-bars__percent">{{ number_format(round($rate['percentage'])) }}%</div>
                                    </div><!-- end review-bars -->
                        ...
                        <div class="review-wrap">
                            ...
                            <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                                <div class="media-img mr-4 rounded-full">
                                    <img class="rounded-full lazy" src="{{ (!empty($review->user->photo)) ? Storage::url('public/upload/users_images/'. $review->user->photo) : asset('storage/upload/images.jpg') }}" alt="User image">
                                </div>
                                <div class="media-body">
                    ...
                    @guest
                        <p><b>For Add Course Review. You need to login first <a href="{{ route('login') }}" style="margin-left: 5px;">Login Here</a></b></p>
                        @else
                        <div class="course-overview-card pt-4">
                            <h3 class="fs-24 font-weight-semi-bold pb-4">Add a Review</h3>
                            <form method="POST" action="{{ route('review_store', ['id' => Auth::user()->id, 'course' => $course->id]) }}" class="row">
                        ...
                        <div class="card-body">
                            <div class="preview-course-video">
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#previewModal">
                                    <img src="{{ Storage::url('public/upload/course/images/' . $course->image) }}" data-src="{{ Storage::url('public/upload/course/images/' . $course->image) }}" alt="course-img" class="w-100 rounded lazy">
                            ...
                            <div class="preview-course-feature-content pt-40px">
                                ...
                                <div class="buy-course-btn-box">
                                    <button type="button" class="btn theme-btn w-100 mb-2" onclick="addToCart({{ $course->id }})"><i class="la la-shopping-cart fs-18 mr-1"></i> Add to cart</button>
                                    <button type="button" class="btn theme-btn w-100 theme-btn-white mb-2" onclick="buyCourse({{ $course->id }})"><i class="la la-shopping-bag mr-1"></i> Buy this course</button>
                                </div>
                                ...
                                <div class="preview-course-incentives">
                                    ...
                                    <div class="" style="display: flex; flex-wrap: wrap; column-gap: 1.6rem;">
                                        <button type="button" class="btn theme-btn theme-btn-sm theme-btn-transparent lh-28 mr-2 mb-2" style="border: none!important; border-bottom: 1px solid #ec5252!important; border-radius: 0%; font-size: 12px; padding: 6px; font-weight: 700;" onmouseover="this.style.border='none'; this.style.border-bottom='1px solid #ec5252';" data-toggle="modal" data-target="#shareModal">Share</button>
                                        <a aria-disabled="false" href="/gift/laravel-build-complete-hotel-booking-reservation-system/?couponCode=OF52424" data-purpose="gift-course" style="border: none!important; border-bottom: 1px solid #ec5252!important; border-radius: 0%; padding: 8px; color: #233d63; font-size: 12px; padding-top: 6px; height: 41px; font-weight: 700;"><span>Gift this course</span></a>
                                        <button type="submit" data-purpose="no-coupon-button" class="btn theme-btn theme-btn-sm theme-btn-transparent lh-28 mr-2 mb-2"  style="border: none!important; border-bottom: 1px solid #ec5252!important; border-radius: 0%; font-size: 12px; padding: 6px; font-weight: 700;" onmouseover="this.style.border='none'; this.style.border-bottom='1px solid #ec5252';"><span>Apply Coupon</span></button>
                                    </div>
                                        ...
                                        <form action="#">
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-append">
                                                    <a type="submit" class="btn theme-btn" style="color: white;" id="applyCoupon" onclick="applyCourseCoupon({{ $course->id }}, {{ $course->instructor_id }})">Apply Code</a>
                                                </div>
                                            </div>
                                            <div id="divMessage">
                    ...
                    <div class="card card-item">
                        <div class="card-body">
                            ...
                            <ul class="generic-list-item generic-list-item-flash">
                                ...
                                <li class="d-flex align-items-center justify-content-between"><span><i class="la la-play-circle-o mr-2 text-color"></i>Lectures</span> {{ $course->lectures->count() }}</li>
                                ...
                                <li class="d-flex align-items-center justify-content-between"><span><i class="la la-lightbulb mr-2 text-color"></i>Skill level</span> {{ $course->course_level }}</li>
                    ...
                    <div class="card card-item">
                        <div class="card-body">
                            ...
                            <ul class="generic-list-item">
                                ...
                                <li><a href="{{ route('category_courses', ['id' => $category->id, 'slug' => $category->category_slug]) }}">{{ $category->category_name }}</a></li>
                                @endforeach
                            </ul>
                        </div>
                    </div><!-- end card -->
                    <div class="card card-item">
                        <div class="card-body">
                            ...
                            <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                                ...
                                <div class="media-body">
                                    <h5 class="fs-15"><a href="{{ route('instructor_details', $courseRelated->instructor->id) }}">{{ $courseRelated->name }}</a></h5>
                                    <span class="d-block lh-18 py-1 fs-14">{{ $courseRelated->instructor->name }}</span>
                                    @if ($courseRelated->discount_price > 0)
                                    <p class="text-black font-weight-semi-bold lh-18 fs-15">${{ $courseRelated->discount_price }} <span class="before-price fs-14">${{ $courseRelated->selling_price }}</span></p>
                                    @else
                                    <p class="text-black font-weight-semi-bold lh-18 fs-15">${{ $courseRelated->selling_price }}</p>
                                    @endif
                                </div>
                            </div><!-- end media -->
                            @endif
...
<section class="related-course-area bg-gray pt-60px pb-60px">
    <div class="container">
        <div class="related-course-wrap">
            <h3 class="fs-28 font-weight-semi-bold pb-35px">More Courses by <a href="{{ route('instructor_details', $course->instructor->id) }}" class="text-color hover-underline">{{ $course->instructor->name }}</a></h3>
                ...
                <div class="card card-item">
                    <div class="card-image">
                        <a href="{{ route('course_details', ['id' => $course->id, 'slug' => $course->slug]) }}" class="d-block">
                            <img class="card-img-top" src="{{ Storage::url('public/upload/course/images/'. $course->image) }}" alt="Card image cap">
                        </a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="copy-to-clipboard">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control form--control copy-input pl-3" value="http://127.0.0.1:82/{{ Request::path() }}">
                        <div class="input-group-append">
        ...
        <div class="modal-content">
            <div class="modal-header border-bottom-gray">
                <div class="pr-2">
                    ...
                    <h5 class="modal-title fs-19 font-weight-semi-bold lh-24" id="previewModalTitle">{{ $course->name }}</h5>
                </div>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true" class="la la-times"></span>
                </button>
            ...
            <div class="modal-body">
                <video controls crossorigin playsinline poster="{{ Storage::url('public/upload/course/images/'. $course->image) }}" id="player">
                    <!-- Video files -->
                    <source src="{{ Storage::url('public/upload/course/videos/'.$course->video_link) }}" type="video/mp4"/>
                </video>
            </div><!-- end modal-body -->
        </div><!-- end modal-content -->
    </div><!-- end modal-dialog -->
