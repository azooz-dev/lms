...
class ProcessCheckoutAction
{
    public function __construct(
        ...
        private readonly ProcessStripePaymentAction $stripePayment
    ) {}
     ...
     */
    public function handle(array $requestData, int $userId, bool $isCreditCard): array
    {
